...
public final class LongPropertyEditor implements PropertyEditor<Object> {
    private Object model;

	private String fieldName;


	public LongPropertyEditor(Object model, String fieldName) {
        this.model = model;
	...
	public String getAsText() {
		try {
			...
			Long value = (Long) d.getReadMethod().invoke(model);
	...
	public void setAsText(String newValue) throws IllegalArgumentException {
		try {
			...
			Long value = "".equals(newValue) ? null : Long.valueOf(newValue);
			d.getWriteMethod().invoke(model, value);
		} catch(IntrospectionException e) {
			throw new RuntimeException(e);
		} catch(IllegalAccessException e) {
			throw new RuntimeException(e);
